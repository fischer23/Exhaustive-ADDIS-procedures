...
gamma=(1/(((1:n)+1)*log((1:n)+1)^1.5))/2.47167      #2.47167 is the approximated value such that the series equals 1
tau=0.8
lambda=0.16
...
results_df=data.frame(seq(0.05,0.4,0.05), n_rej_Alpha,n_rej_Graph,n_rej_Spending, n_rej_EGraph, n_rej_ESpending, n_rej_EIGraph)
...
plot_real=ggplot(results_df, aes(seq.0.05..0.4..0.05.)) + 
  ...
  scale_shape_manual(name  ="Procedure",values=c("Alpha-Spending"=8,"ADDIS-Graph"=16,"ADDIS-Spending"=4, "E-ADDIS-Graph"=5, "E-ADDIS-Spending"=6,"EI-ADDIS-Graph"=17),labels = c("Alpha-Spending"=lab[1],"ADDIS-Graph"=lab[2],"ADDIS-Spending"=lab[3],"E-ADDIS-Graph"=lab[4],"E-ADDIS-Spending"=lab[5], "EI-ADDIS-Graph"=lab[6]))+
  scale_color_manual(name  ="Procedure", values = c("Alpha-Spending"=cols[1],"ADDIS-Graph"=cols[2],"ADDIS-Spending"=cols[3], "E-ADDIS-Graph"=cols[4], "E-ADDIS-Spending"=cols[5], "EI-ADDIS-Graph"=cols[6]), labels = c("Alpha-Spending"=lab[1],"ADDIS-Graph"=lab[2],"ADDIS-Spending"=lab[3],"E-ADDIS-Graph"=lab[4],"E-ADDIS-Spending"=lab[5], "EI-ADDIS-Graph"=lab[6]))+
  xlab("FWER level")+
...
ggsave("results/Figure6.pdf",plot=plot_real)
