...
results_df = data.frame(idx=seq(0.05, 0.4, 0.05), n_rej_Alpha, n_rej_Graph, n_rej_Spending, n_rej_EGraph,
...
plot_real = ggplot(results_df, aes(idx)) + 
  ...
  scale_shape_manual(name = "Procedure", 
                     values = c("Alpha-Spending" = 8, "ADDIS-Graph" = 16, "ADDIS-Spending" = 4, "E-ADDIS-Graph" = 5,
                                "E-ADDIS-Spending" = 6, "EI-ADDIS-Graph" = 17), 
                     labels = c("Alpha-Spending" = lab[1], "ADDIS-Graph" = lab[2], "ADDIS-Spending" = lab[3], 
                                "E-ADDIS-Graph" = lab[4], "E-ADDIS-Spending" = lab[5], "EI-ADDIS-Graph" = lab[6])) +
  scale_color_manual(name = "Procedure", 
                     values = c("Alpha-Spending" = cols[1], "ADDIS-Graph" = cols[2], "ADDIS-Spending" = cols[3], 
